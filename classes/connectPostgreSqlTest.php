...
//die(print_r($oStock));
        ...
        $sReq = "INSERT INTO test.geosirene(siren, nic, siret, statutdiffusionetablissement, datecreationetablissement, 
...
//    }
    ...
    public function updateStockGeoInsee($date_integration) {
        ...
        $sQueryGeosirene = "SELECT * FROM test.geosirene WHERE date_integration=:date_integration";
        $db = $this->getConnexion();
